<?php
/**
 * Template Name: Beddings - 02 Duvet Covers
 *
 * @package WordPress
          ...
          <div class="common-tabs-container type-large">
            <div class="tabs-header">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="cushions-tab" data-toggle="tab" href="#cushions" role="tab" aria-controls="cushions" aria-selected="false">Duvet Covers</a>
                </li>
                <li class="nav-item">
