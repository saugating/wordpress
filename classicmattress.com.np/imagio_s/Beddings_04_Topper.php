<?php
/**
 * Template Name: Beddings - 04 Topper
 *
 * @package WordPress
          ...
          <div class="common-tabs-container type-large">
            <div class="tabs-header">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="topper-tab" data-toggle="tab" href="#topper" role="tab" aria-controls="topper" aria-selected="false">Topper & Protector</a>
                </li>
                <li class="nav-item">
