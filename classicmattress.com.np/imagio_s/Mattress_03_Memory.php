<?php
/**
 * Template Name: Mattress - 03 Memory
 *
 * @package WordPress
          ...
          <div class="common-tabs-container">
            <div class="tabs-header">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo site_url(); ?>/products/mattress/pocket-spring">Pocket Spring</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" id="quilts-tab" data-toggle="tab" href="#quilts" role="tab" aria-controls="quilts" aria-selected="false">Memory Foam</a>
                </li>
              </ul>
            </div>
