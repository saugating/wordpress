<?php
/**
 * Template Name: Beddings - 03 Pillowcases
 *
 * @package WordPress
          ...
          <div class="common-tabs-container type-large">
            <div class="tabs-header">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="quilts-tab" data-toggle="tab" href="#quilts" role="tab" aria-controls="quilts" aria-selected="false">Pillowcases</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tabs-body type-small-padding">
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="quilts" role="tabpanel" aria-labelledby="quilts-tab">
