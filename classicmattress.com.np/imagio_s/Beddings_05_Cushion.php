<?php
/**
 * Template Name: Beddings - 05 Cushions
 *
 * @package WordPress
          ...
          <div class="common-tabs-container type-large">
            <div class="tabs-header">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo site_url(); ?>/products/bedding-accessories/bedsheets">Bedsheets</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="bolster-tab" data-toggle="tab" href="#bolster" role="tab" aria-controls="bolster" aria-selected="false">Cushions & Bolster</a>
                </li>
              </ul>
            </div>
            <div class="tabs-body type-small-padding">
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="bolster" role="tabpanel" aria-labelledby="bolster-tab">
