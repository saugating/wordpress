<?php
/**
 * Template Name: Mattress - 01 Coir
 *
 * @package WordPress
          ...
          <div class="common-tabs-container">
            <div class="tabs-header">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="pillows-tab" data-toggle="tab" href="#pillows" role="tab" aria-controls="pillows" aria-selected="false">Coir</a>
                </li>
                <li class="nav-item">
