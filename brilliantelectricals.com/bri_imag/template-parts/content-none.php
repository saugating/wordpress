...
<div>
	<section class="no-results not-found">
		...
		<div class="section-body page-content">
			<?php
			...
			<p style="margin-bottom:30px;"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', '_s' ); ?></p>
