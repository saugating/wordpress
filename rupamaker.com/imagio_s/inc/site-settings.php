...
class Site_Setting_attributes
{
    ...
    {
        $this->attributes = [
            array('id'=>'ic_contact_address','title'        =>'Contact Address :','cb'              =>'ic_contact_no_cb','type'         =>'text'),
            array('id'=>'ic_contact_email','title'          =>'Contact Email :','cb'                =>'ic_contact_email_cb','type'      =>'text'),
            array('id'=>'ic_contact_no','title'             =>'Contact Number :','cb'               =>'ic_contact_no_cb','type'         =>'text'),

            array('id'=>'ic_google_map_link','title'        =>'Google Map Link :','cb'              =>'ic_google_map_link_cb','type'    =>'text'),
            ...
            array('id'=>'ic_yt_link','title'                =>'Youtube Channel Link :','cb'        =>'ic_social_links_cb','type'        =>'url'),
        ];
    }
}
