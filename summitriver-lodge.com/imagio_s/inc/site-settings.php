...
class Site_Setting_attributes
{
    ...
    {
        $this->attributes = [
            array('id'=>'ic_lodge_area','title'            =>'Lodge Area :','cb'            =>'ic_lodge_area_cb','type'             =>'text'),
            array('id'=>'ic_lodge_city','title'            =>'Lodge City :','cb'            =>'ic_lodge_city_cb','type'             =>'text'),
            array('id'=>'ic_contact_person','title'        =>'Contact Person :','cb'        =>'ic_contact_person_cb','type'         =>'text'),
            array('id'=>'ic_landline_no1','title'          =>'Landline Number :','cb'      =>'ic_landline_no1_cb','type'           =>'text'),
            /*array('id'=>'ic_mobile_no1','title'            =>'Mobile Number :','cb'        =>'ic_mobile_no1_cb','type'             =>'text'),*/
            array('id'=>'ic_contact_email','title'         =>'Contact Email :','cb'         =>'ic_contact_email_cb','type'          =>'text'),
            array('id'=>'ic_social_text','title'           =>'Social Text :','cb'           =>'ic_social_text','type'               =>'text'),
            ...
            array('id'=>'ic_tik_link','title'              =>'Tiktok Link :','cb'           =>'ic_social_links_cb','type'           =>'url'),
            array('id'=>'ic_google_map_link_cb','title'    =>'Google Map :','cb'            =>'ic_google_map_link_cb','type'            =>'url'),
        ];
    }
}
...
class Site_Settings extends Site_Setting_attributes
{
    ...
    public function ic_lodge_city_cb( $args )
    {
        printf(
    ...
    public function ic_lodge_area_cb( $args )
    {
        printf(
            '<input type="text" id="'.$args.'" class="regular-text" name="ic_options['.$args.']" value="%s" required="required" />',
            isset( $this->options[$args] ) ? esc_attr( $this->options[$args]) : ''
    ...
    public function ic_contact_person_cb( $args )
    {
        printf(
            '<input type="text" id="'.$args.'" class="regular-text" name="ic_options['.$args.']" value="%s" required="required" />',
            isset( $this->options[$args] ) ? esc_attr( $this->options[$args]) : ''
    ...
    public function ic_landline_no1_cb( $args )
    {
        printf(
            '<input type="text" id="'.$args.'" class="regular-text" name="ic_options['.$args.']" value="%s" required="required" />',
            isset( $this->options[$args] ) ? esc_attr( $this->options[$args]) : ''
    ...
    public function ic_mobile_no1_cb( $args )
    {
        printf(
            '<input type="text" id="'.$args.'" class="regular-text" name="ic_options['.$args.']" value="%s" required="required" />',
            isset( $this->options[$args] ) ? esc_attr( $this->options[$args]) : ''
    ...
    public function ic_social_text( $args )
    {
        printf(
            '<input type="text" id="'.$args.'" class="regular-text" name="ic_options['.$args.']" value="%s" required="required" />',
            isset( $this->options[$args] ) ? esc_attr( $this->options[$args]) : ''
