...
if ( ! defined( '_I_VERSION' ) ) {
    define( '_I_VERSION', '2.0.9' );
}
/*!-------------------------------------- Version Ends ------------------------------------*/

/*!------------------------------------ Includes Starts -----------------------------------*/
include 'inc/custom-posts-type.php';
include 'inc/meta-box-room.php';
include 'inc/meta-box-story.php';
...
function theme_stylesheets()
{
    ...
    wp_register_style('flaticon', get_stylesheet_directory_uri() . '/css/bowercomponent/flaticon.css', array(), _I_VERSION);
    ...
    /********** Site Starts ***********/
    wp_register_style('global', get_stylesheet_directory_uri() . '/css/global.css', array(), _I_VERSION);
    wp_enqueue_style( 'global');
    wp_register_style('thestyles', get_stylesheet_directory_uri() . '/css/thestyles.css', array(), _I_VERSION);
    wp_enqueue_style( 'thestyles');
    wp_register_style('responsive', get_stylesheet_directory_uri() . '/css/responsive.css', array(), _I_VERSION);
...
/*!----------------------------------- Thumbnail Size Ends --------------------------------*/
add_image_size('Large', 500, 667, true);
add_image_size('section_image', 1920, 1080, true);
add_image_size('gallery_thumb', 360, 203, true);
add_image_size('process_thumb', 300, 300, true);
/*!----------------------------------- Thumbnail Size Ends --------------------------------*/
