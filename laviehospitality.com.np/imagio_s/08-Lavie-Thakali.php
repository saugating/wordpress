<?php
/**
 * Template Name: Lavie Thakali Template
 *
 * @package WordPress
  ...
  <section class="common-lavie-intro">
    <div class="custom-container">
      ...
      <div class="video-container">
        ...
        <div class="flex-cont">
          <?php if( have_rows('video', 248) ): ?>
            <?php while( have_rows('video', 248) ): the_row(); ?>
        ...
        <div class="flex-item">
          <div class="inner">
            ...
            <div class="section-links">
              <a href="<?php echo get_the_permalink( 248 ); ?>menu/" class="co-btn type-fill">
                View Menu
              </a>
            </div>
          </div>
