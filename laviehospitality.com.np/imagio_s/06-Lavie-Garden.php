<?php
/**
 * Template Name: Lavie Garden Template
 *
 * @package WordPress
  ...
  <section class="common-lavie-intro">
    <div class="custom-container">
      ...
      <div class="video-container">
        ...
        <div class="flex-cont">
          <?php if( have_rows('video', 166) ): ?>
            <?php while( have_rows('video', 166) ): the_row(); ?>
...
<!--    --><?php //endif; wp_reset_query();?>
  ...
  <section>
    <div class="common-backdrop lavie_garden" id="book-now">
      <div class="custom-container remove-top-bottom-padding">
        <div class="block-cont">
          ...
          <div class="block-item">
            <div class="common-form cst-fade">
              <?php echo do_shortcode('[contact-form-7 id="593" title="Reservation lavie Garden"]');?>
            </div>
          </div>
        </div>
      </div>
